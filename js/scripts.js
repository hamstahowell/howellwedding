$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Nicholas and Rebecca's Wedding",

            // Event start date
            start: new Date('Apr 26, 2025 13:30'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbwcp4-pgxekWg4rHA9LQjADtGvH2tQam2Bom5hMFHkUCjTG-TVgvpdAs1-dO-TtOb1t/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: -25.766800214594653, lng:  28.236507494520982};
...
function initBBSRMap() {
    var la_fiesta = {lat: -25.766800214594653, lng:  28.236507494520982};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
