...
$(document).ready(function () {
    ...
    var r = createCalendar({
        ...
        data: {
            ...
            address:
                "Cafe Mystique - c/o Jan Shoba and Justice Mahomed St, Pretoria, 0011",
            description:
                "We can't wait to see you on our big day. For any queries or issues, please contact Nicholas or Rebecca.",
        },
    });
    $("#add-to-cal").html(r),
        $("#rsvp-form").on("submit", function (e) {
            ...
            $("#alert-wrapper").html(
                ...
                "2ac7f43695eb0479d5846bb38eec59cc" !==
                    ...
                    : $.post(
                          "https://script.google.com/macros/s/AKfycbwcp4-pgxekWg4rHA9LQjADtGvH2tQam2Bom5hMFHkUCjTG-TVgvpdAs1-dO-TtOb1t/exec",
                          t
                      )
                          .done(function (e) {
                              console.log(e),
